...
and published as a :term:`Version <asset version>` to ftrack. In most cases this
means that one or more files will be saved to disk or uploaded to ftrack where
others can :ref:`import <using/import>` and view them.
