...
'''ftrack connect adobe documentation build configuration file.'''
...
project = u'ftrack connect adobe'
...
intersphinx_mapping = {
    ...
    'ftrack': (
        'http://rtd.ftrack.com/docs/ftrack-connect/en/stable/', None
    )
}
